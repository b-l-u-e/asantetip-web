...
<footer class="relative flex flex-col items-center overflow-hidden bg-gray-50 dark:bg-gray-900 py-20 md:py-40">
  <div class="container relative z-[1] m-auto px-6 md:px-12">
    <div class="m-auto md:w-12/12 lg:w-12/12 xl:w-10/12">
      <div class="flex flex-wrap items-center justify-between md:flex-nowrap">
        <div
        class="flex flex-col lg:flex-row  w-full justify-center gap-12 text-gray-600 dark:text-gray-300 md:justify-between">
                ...
                <div class="w-full flex justify-between lg:w-auto">
                    ...
                    class="p-3">
                        <div class="flex flex-row gap-x-5 items-center">
                            <div class="ml-2 text-2xl font-bold text-gray-900 dark:text-white">AsanteTip</div>
                        </div>
                    </a>
                </div>
                <div>
  ...
  <div
    class="flex flex-row justify-between m-auto mt-16 w-10/12 gap-x-6 text-center sm:w-5/12 sm:text-left ">
        <div class="text-gray-500 dark:text-gray-400">
            Asantetip &copy; <span id="year"></span>2023
        </div>
        ...
        {{-- <div class="text-gray-500 dark:text-gray-400">Ready to order? <a href="/contact" class="font-bold text-green-700"> Contact Us</a></div> --}}
    </div>
